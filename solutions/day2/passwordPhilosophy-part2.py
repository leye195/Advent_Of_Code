...
def solution(data_list):
    ...
    for data in data_list:
        from_to,letter,word = data.split(" ")
        first_index,last_index = map(int,from_to.split("-"),)
        letter = letter[:-1]
        if word[first_index-1]==letter and word[last_index-1]!=letter:
            answer+=1
        elif word[first_index-1]!=letter and word[last_index-1]==letter:
            answer+=1
    return answer
